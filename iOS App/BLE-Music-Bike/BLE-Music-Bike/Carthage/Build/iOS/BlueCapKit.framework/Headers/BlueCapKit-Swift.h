...
- (CLAuthorizationStatus)authorizationStatus SWIFT_WARN_UNUSED_RESULT;
...
+ (BOOL)significantLocationChangeMonitoringAvailable SWIFT_WARN_UNUSED_RESULT;
- (void)stopMonitoringSignificantLocationChanges;
- (BOOL)deferredLocationUpdatesAvailable SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)init;
- (BOOL)isMonitoringRegion:(NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)isRangingAvailable SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init;
- (BOOL)isRangingRegionWithIdentifier:(NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
...
- (void)stopScanning;
- (NSArray<Peripheral *> * _Nonnull)retrieveConnectedPeripheralsWithServices:(NSArray<CBUUID *> * _Nonnull)services SWIFT_WARN_UNUSED_RESULT;
- (NSArray<Peripheral *> * _Nonnull)retrievePeripheralsWithIdentifiers:(NSArray<NSUUID *> * _Nonnull)identifiers SWIFT_WARN_UNUSED_RESULT;
- (NSArray<Peripheral *> * _Nonnull)retrievePeripherals SWIFT_WARN_UNUSED_RESULT;
...
- (NSDictionary<NSString *, NSString *> * _Nullable)stringValue:(NSData * _Nullable)data SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nullable)dataFromString:(NSDictionary<NSString *, NSString *> * _Nonnull)stringValue SWIFT_WARN_UNUSED_RESULT;
- (BOOL)propertyEnabled:(CBCharacteristicProperties)property SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)propertyEnabled:(CBCharacteristicProperties)property SWIFT_WARN_UNUSED_RESULT;
- (BOOL)permissionEnabled:(CBAttributePermissions)permission SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nullable)dataFromString:(NSDictionary<NSString *, NSString *> * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
...
- (NSArray<MutableService *> * _Nullable)serviceWithUUID:(CBUUID * _Nonnull)uuid SWIFT_WARN_UNUSED_RESULT;
- (NSArray<MutableCharacteristic *> * _Nullable)characteristicsWithUUID:(CBUUID * _Nonnull)uuid SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init;
- (nonnull instancetype)initWithOptions:(NSDictionary<NSString *, id> * _Nullable)options;
- (nonnull instancetype)initWithQueue:(dispatch_queue_t _Nonnull)queue options:(NSDictionary<NSString *, id> * _Nullable)options OBJC_DESIGNATED_INITIALIZER;
- (void)reset;
- (void)invalidate;
- (void)remove:(MutableService * _Nonnull)service;
- (void)removeAllServices;
- (BOOL)updateValue:(NSData * _Nonnull)value forCharacteristic:(MutableCharacteristic * _Nonnull)characteristic SWIFT_WARN_UNUSED_RESULT;
